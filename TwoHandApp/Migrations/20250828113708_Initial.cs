        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IntervalDay = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ads_AdPackages_AdPackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AdId = table.Column<int>(type: "integer", nullable: false),
                    PackagePriceId = table.Column<Guid>(type: "uuid", nullable: false),
                    PaidPrice = table.Column<decimal>(type: "numeric", nullable: true),
                    StartDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EndDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    BoostsRemaining = table.Column<int>(type: "integer", nullable: true),
                    LastBoostedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserAdPackages_Ads_AdId",
                        column: x => x.AdId,
                        principalTable: "Ads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserAdPackages_PackagePrices_PackagePriceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAdPackages_AdId",
                table: "UserAdPackages",
                column: "AdId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAdPackages_PackagePriceId",
                table: "UserAdPackages",
